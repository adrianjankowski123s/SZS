...
namespace SZS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.PracownikUmiejetnosc = new SelectList(db.Umiejetnosci, "Id", "Nazwa");
            ViewBag.Miejscowosc = new SelectList(db.Miejscowosc, "Id", "Nazwa");
            ViewBag.Miejscowosc1 = new SelectList(db.Miejscowosc, "Id", "Nazwa");
            ViewBag.Wyksztalcenie = new SelectList(db.Wyksztalcenie, "Id", "Nazwa");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Imie + " " + model.Nazwisko, Email = model.Email, Imie = model.Imie, Nazwisko = model.Nazwisko, Plec = model.Plec, DataUrodzenia = model.DataUrodzenia, IDMiejsceUrodzenia = model.IDMiejsceUrodzenia, IDMiejscowosc = model.IDMiejscowosc, IDWyksztalcenia = model.IDWyksztalcenia, Pesel = model.Pesel, Ulica = model.Ulica, KodPocztowy = model.KodPocztowy  };
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index", "Szkolenie");
                }
                AddErrors(result);
            }
            ViewBag.PracownikUmiejetnosc = new SelectList(db.Umiejetnosci, "Id", "Nazwa");
