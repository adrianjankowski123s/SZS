...
namespace SZS
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new CustomUserStore(context.Get<Models.SZSModel>()));
            ...
            manager.RegisterTwoFactorProvider("Kod — telefon", new PhoneNumberTokenProvider<ApplicationUser, int>
            {
                MessageFormat = "Twój kod zabezpieczający: {0}"
            });
            manager.RegisterTwoFactorProvider("Kod — e-mail", new EmailTokenProvider<ApplicationUser, int>
            {
    ...
    public class ApplicationRoleManager : RoleManager<CustomRole, int>
    {
        ...
        {
            return new ApplicationRoleManager(new CustomRoleStore(context.Get<Models.SZSModel>()));
        }
    }
